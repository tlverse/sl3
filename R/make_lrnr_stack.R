...
#'
#' @param ... Each argument is a list that will be passed to \code{\link{make_learner}}
#'
#' @return An \code{sl3} \code{Stack} consisting of the learners passed in as arguments
