...
`sl3` is a modern implementation of the Super Learner algorithm of van der Laan
et al. The Super Learner algorithm performs ensemble learning in one of
two fashions:
...
2. The "ensemble" Super Learner can be used to assign weights to specified
   ...
   has also been called _stacked regression_ (Breiman, 1996).
...
* [Modern Machine Learning in R](https://sl3.tlverse.org/articles/intro_sl3.html) `vignette("intro_sl3")`
* [Defining New sl3 Learners](https://sl3.tlverse.org/articles/custom_lrnrs.html) `vignette("custom_lrnrs")`
* [SuperLearner Benchmarks](https://sl3.tlverse.org/articles/SuperLearner_benchmarks.html) `vignette("SuperLearner_benchmarks")`
