...
addition, the help files for [`sl3_Task`](https://jeremyrcoyle.github.io/sl3/reference/sl3_Task.html) and
[`Lrnr_base`](https://jeremyrcoyle.github.io/sl3/reference/Lrnr_base.html) are good resources for how those objects can be
used. If you're interested in defining learners that fit sub-learners, reading
the documentation of the
[`delayed`](https://jeremyrcoyle.github.io/delayed/articles/delayed.html)
...
GitHub](https://github.com/jeremyrcoyle/sl3) to request that your learned be
