...
[`Lrnr_base`](https://tlverse.org/sl3/reference/Lrnr_base.html) are good
...
[`delayed`](https://tlverse.org/delayed/articles/delayed.html) package will be
helpful.
...
documentation, written in the [roxygen](https://roxygen2.r-lib.org/)
...
It's also important to [test](https://testthat.r-lib.org/) your learner.
