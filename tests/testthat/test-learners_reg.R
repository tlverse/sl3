...
### nrounds is always needed
# test_learner(Lrnr_xgboost, task, nrounds = 10)
...
### GLM, i.e., use linear model for at each boosting stage
# test_learner(Lrnr_xgboost, task, nrounds = 50,
# booster = "gblinear")

### GBM (default), i.e., use tree model for at each boosting stage
# test_learner(Lrnr_xgboost, task, nrounds = 10,
# booster = "gbtree")

### another type of tree model
## test_learner(Lrnr_xgboost, task, nrounds = 50, booster = 'dart')

# test_learner(Lrnr_xgboost, task_with_interactions, nrounds = 10,
# booster = "gbtree",
# covariates = c("cyl", "disp", "drat", "cyl_disp", "hp_drat"))
