...
#'   \item{\code{append_interaction_matrix}}{Whether to \code{lrnr_baseline} should be fit on `cbind(task$X,V)` where `V` is the design matrix obtained from \code{formula_sp}.
