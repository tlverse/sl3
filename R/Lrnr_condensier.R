...
#' the \code{condensier} package. Fitting is done with the \code{\link[condensier]{fit_density}}
#' function.
#' @docType class
...
#' \describe{
#'
#' \item{\code{bin_method=c("equal.mass", "equal.len", "dhist")}}{The type of smoothing to be performed. See documentation of
#'  the \code{condensier} package for details.
#' }
#' \item{\code{nbins=5}}{The number of observations per bin. See documentation of the
#'  \code{condensier} package for details.
#' }
#' \item{\code{max_n_cat=20}}{Maximum number of unique levels for categorical outcomes.
#'  See documentation of the \code{condensier} package for details.
#' }
#' \item{\code{pool=FALSE}}{Whether pooling of data across bins should be performed. See
#'  documentation of the \code{condensier} package for details.
#' }
#' \item{\code{max_n_bin=NA}}{Maximum number of observations per single bin for continuous
#'  outcome. See documentation of the \code{condensier} package for details.
#' }
#' \item{\code{parfit=FALSE}}{Whether to invoke parallelization in the fitting procedure. See
#'  documentation of the \code{condensier} package for details.
#' }
#' \item{\code{bin_estimator=make_learner(Lrnr_glm_fast, family=binomial())}}{The classification algorithm to be used in the fitting
#'  process. See documentation of the \code{condensier} package for details.
#' }
#' \item{\code{intrvls=NULL}}{An interval range to be used for custom bin definitions. See
#'  documentation of the \code{condensier} package for details.
#' }
#' }
