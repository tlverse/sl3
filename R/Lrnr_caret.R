...
#'   `method` to \code{\link[mgcv]{gam}}. For a detailed description of the 
...
#'   
#'   \item{\code{trControl}}{An optional \code{\link[mgcv]{trainControl}} object 
...
#'   documentation for \code{\link[mgcv]{gam}}.}
#'   
