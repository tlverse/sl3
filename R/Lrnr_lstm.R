...
#'
#' This learner supports long short-term memory recurrent neural network algorithm. In order to use this learner, 
#' you will need keras Python module 2.0.0 or higher. Note that all preprocessing, such as differencing and 
#' seasonal effects, should be addressed before using this learner. 
#' 
#' @docType class
...
Lrnr_lstm <- R6Class(classname = "Lrnr_lstm", inherit = Lrnr_base, portable = TRUE, class = TRUE,
                          ...
                          private = list(
                            ...
                            .predict = function(task = NULL) {
                              ...
                              predictions <- keras_predict(model,args$x,batch_size=args$batch_size)
